          ...
          <div className="flex flex-col lg:flex-row justify-center items-start pb-5 gap-6">
            <div className="lg:w-1/2 bg-amber-900 w-full text-white rounded-2xl p-4">
              ...
              {BMI && (
                <div className="border-amber-700 bg-amber-950 border-2 rounded-lg mt-6 p-4 flex flex-col">
                  <p className="text-2xl text-center">
                    Your BMI is <strong className="ml-2 text-3xl">{BMI}</strong>
                  </p>
              ...
              <p className="text-center text-sm text-neutral-400 mt-4">
                ...
                tool. The BMI calculator does not determine eligibility for any
                weight loss medications or treatments provided via the Hims/Hers
                ...
                health and medical history. BMI may not be accurate for
            ...
            <div className="bg-[url(/media/weight-page-pic.png)] bg-cover bg-no-repeat bg-center w-full lg:w-1/2 text-white rounded-2xl p-4 flex flex-col justify-between h-160">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-center text-sm text-neutral-300 mt-4">
                  *Along with a reduced calorie diet and increased exercise. In
                  a 68-week clinical study of semaglutide, about 1 in 3 adults
                  with obesity or with overweight and weight-related medical
                  problems achieved 20% weight loss. Average weight loss
                  achieved was 15%. semaglutide is a registered trademark of
                  Novo Nordisk A/S.
                </p>
              </div>
            </div>
